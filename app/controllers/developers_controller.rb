class DevelopersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @developer.update(developer_params)
        format.html { redirect_to @developer, notice: "Developer was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to developers_path, notice: "Developer was successfully destroyed.", status: :see_other }
